...
public class ComputerTurn extends Turn {
	...
	public ComputerTurn(String name, int turnNr, Board board, Tile[] hand, ArrayList<Coordinate> coordinates) {
	...
	private void determinemove(Board deepcopy, Tile[] hand, ArrayList<Coordinate> coordinates) {
